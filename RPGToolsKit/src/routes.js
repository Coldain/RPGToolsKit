...
const AsyncCharacters = MyLoadable({ loader: () => import('./containers/Characters/Characters') });
...
const Routes = [
    <RestrictedRoute type='private' path="/characters" exact component={AsyncCharacters} />,
